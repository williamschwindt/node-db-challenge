...
- [ ] Explain the difference between `Relational Databases` and `SQL`.
  a relational database is a database that organizes data with defined relationships. sql is the language used to access specific data in the data base as well as update, delete, or add new data.

- [ ] Why do tables need a `primary key`?
  It makes it easier to maintain data as well as keep data normalized to keep out data anomalies

- [ ] What is the name given to a table column that references the primary key on another table.
  foreign key

- [ ] What do we need in order to have a _many to many_ relationship between two tables.
  another table that caontains two foreign key collums to refernece the two tables
